...
print "<div><h2>2 Mile - Overall</h2>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 18 and Under</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 19 and Over</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 19 to 29</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 30 to 39</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 40 to 49</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 50 to 59</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 60 to 69</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 3";
$result = $conn->query($sql);
print "<div><h2>2 Mile - 70 and Over</h2>";
include "printResults.php";
print "</div>";
...
$sql = "SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName, s.LastName, s.Gender, s.Birthdate,"
    ...
    . "Limit 1";
$result = $conn->query($sql);
print "<div><h2>2 Mile - Top Fin</h2>";
include "printResults.php";
print "</div>";
