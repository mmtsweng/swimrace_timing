...
--
-- Host: localhost:3306
-- Generation Time: Nov 06, 2019 at 07:07 PM
...
SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName,
    s.LastName, s.City, s.State, s.Country, r.Description,
...
SELECT r.ID, rs.RacerNumber, rs.SwimmerID, s.FirstName,
    s.LastName, s.Gender, s.Birthdate, s.City, s.State,
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `INSERT_SWIMMER` (IN `in_firstname` VARCHAR(255), IN `in_lastname` VARCHAR(255), IN `in_city` VARCHAR(64), IN `in_country` VARCHAR(64), IN `in_birthdate` DATE, IN `in_gender` VARCHAR(4), IN `in_state` VARCHAR(4))  NO SQL
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `REPORT_OVERALL` (IN `in_raceid` INT, IN `in_limit` INT)  NO SQL
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `REPORT_OVERALL_19OVER` (IN `in_raceid` INT, IN `in_limit` INT)  NO SQL
SELECT r.ID, rs.RacerNumber, rs.SwimmerID,
    s.FirstName, s.LastName, s.Gender, s.Birthdate,
    s.City, s.State, s.Country,
    TIMESTAMPDIFF(YEAR, s.Birthdate, NOW()) as Age,
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `REPORT_OVERALL_FIN` (IN `in_raceid` INT, IN `in_limit` INT)  NO SQL
SELECT r.ID, rs.RacerNumber, rs.SwimmerID,
    s.FirstName, s.LastName, s.Gender, s.Birthdate,
    s.City, s.State, s.Country,
    TIMESTAMPDIFF(YEAR, s.Birthdate, NOW()) as Age,
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `REPORT_OVERALL_UNDER19` (IN `in_raceid` INT, IN `in_limit` INT)  NO SQL
SELECT r.ID, rs.RacerNumber, rs.SwimmerID,
    s.FirstName, s.LastName, s.Gender, s.Birthdate,
    s.City, s.State, s.Country,
    TIMESTAMPDIFF(YEAR, s.Birthdate, NOW()) as Age,
...
CREATE DEFINER=`swimrace`@`localhost` PROCEDURE `REPORT_WINNERS_BY_RACE_AGE` (IN `in_raceid` INT, IN `in_minage` INT, IN `in_maxage` INT, IN `in_gender` VARCHAR(2), IN `in_limit` INT)  NO SQL
SELECT r.ID, rs.RacerNumber, rs.SwimmerID,
    s.FirstName, s.LastName, s.Gender, s.Birthdate,
    s.City, s.State, s.Country,
    TIMESTAMPDIFF(YEAR, s.Birthdate, NOW()) as Age,
...
(1, 1, '2019-11-06 07:01:10', 1),
(2, 2, '2019-11-06 08:55:15', 1),
(3, 3, '2019-11-06 09:03:25', 1);
...
INSERT INTO `TimeSwimmer` (`ID`, `RaceSwimmerID`, `FinishTime`) VALUES
(1, 73, '2019-11-06 12:08:40'),
(2, 194, '2019-11-06 11:17:36'),
